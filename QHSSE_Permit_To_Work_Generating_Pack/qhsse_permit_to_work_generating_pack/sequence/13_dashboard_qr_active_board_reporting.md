...
Membangun QR permit, field verification, active permit board, high-risk work board, dashboard KPI, PDF/Excel export, dan reports.
...
```text
SELESAI PTW SEQUENCE 13: Dashboard, QR Permit, Active Board & Reporting
```
