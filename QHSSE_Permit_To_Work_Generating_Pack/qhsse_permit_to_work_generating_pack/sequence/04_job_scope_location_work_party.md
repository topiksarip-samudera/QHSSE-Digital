...
Membangun data job scope, work location, contractor, supervisor, worker list, role in work, dan work schedule.
...
```text
SELESAI PTW SEQUENCE 04: Job Scope, Location & Work Party
```
