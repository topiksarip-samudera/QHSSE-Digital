...
Membangun obsolete, archive, retention rule, restore, legal hold optional, watermark/status obsolete, dan prevent obsolete document for new usage.
...
Retention policy
Legal hold optional
Prevent obsolete for new links
Obsolete watermark/status
Obsolete history
```
...
```text
SELESAI DOCUMENT CONTROL SEQUENCE 09: Obsolete, Archive & Retention
```
