...
Membangun document register, create/edit/detail/list, status dasar, owner department, applicability, dan tenant-safe CRUD.
...
Document detail
Document owner
Applicable site/department
Document status
Soft delete/archive draft
Tenant-safe listing
```
