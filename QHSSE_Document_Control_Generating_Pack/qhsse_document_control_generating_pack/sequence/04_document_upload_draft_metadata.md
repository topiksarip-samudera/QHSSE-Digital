...
Membangun upload draft file, metadata lengkap, file preview, validation, draft revision, dan attachment/file service integration.
...
```text
SELESAI DOCUMENT CONTROL SEQUENCE 04: Document Upload, Draft & Metadata
```
