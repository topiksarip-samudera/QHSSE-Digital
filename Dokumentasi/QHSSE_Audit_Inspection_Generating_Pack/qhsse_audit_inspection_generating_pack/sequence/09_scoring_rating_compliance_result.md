...
Membangun scoring engine, compliance rating, audit score, inspection score, failed critical item, dan score history.
...
Inspection score
Compliance rating
Critical item fail rule
Score history
Rating by site/department
```
