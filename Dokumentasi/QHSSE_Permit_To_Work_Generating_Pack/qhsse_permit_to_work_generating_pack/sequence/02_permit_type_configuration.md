...
Membangun permit type configurable, requirement rules, conditional fields, validity, mandatory checks, dan validation mode block/warning/info.
...
```text
Permit type CRUD
Requirement per permit type
Mandatory JSA configuration
Mandatory gas test configuration
Mandatory LOTO configuration
Mandatory competency configuration
Default validity hours
Conditional fields
Validation mode: block/warning/info
```
