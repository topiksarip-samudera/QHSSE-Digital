# RISK SEQUENCE 05 — HIRADC / HIRARC Builder

## Tujuan

Membuat HIRADC berbasis aktivitas: hazard, consequence, existing control, initial risk, additional control, residual risk, PIC, due date, approval.
...
```text
Implementasikan Risk Sequence 05: HIRADC / HIRARC Builder.
