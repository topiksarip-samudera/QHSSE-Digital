# RISK SEQUENCE 03 — Hazard Identification & Consequence Library

## Tujuan

Membuat hazard library, hazard category, consequence library, mapping hazard-consequence, import/export, dan active/inactive item.
...
```text
Implementasikan Risk Sequence 03: Hazard Identification & Consequence Library.
