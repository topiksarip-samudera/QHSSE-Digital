# RISK SEQUENCE 02 — Risk Register Core

## Tujuan

Membuat risk register dasar: list, create, detail, edit, archive, search, filter, status, owner, numbering, dan tenant isolation.
...
```text
Implementasikan Risk Sequence 02: Risk Register Core.
