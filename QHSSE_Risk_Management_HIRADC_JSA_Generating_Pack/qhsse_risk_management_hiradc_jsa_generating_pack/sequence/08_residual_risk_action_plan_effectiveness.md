# RISK SEQUENCE 08 — Residual Risk, Action Plan & Control Effectiveness

## Tujuan

Menghubungkan residual risk dengan action plan, Action Tracking Core, effectiveness review, overdue action, dan recalculation.
...
```text
Implementasikan Risk Sequence 08: Residual Risk, Action Plan & Control Effectiveness.
