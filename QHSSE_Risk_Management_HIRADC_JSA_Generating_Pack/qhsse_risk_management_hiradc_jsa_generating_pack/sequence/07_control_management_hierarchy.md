# RISK SEQUENCE 07 — Control Management & Hierarchy of Control

## Tujuan

Membuat control register, hierarchy of control, critical controls, control owner, effectiveness, verification, dan failed control action.
...
```text
Implementasikan Risk Sequence 07: Control Management & Hierarchy of Control.
