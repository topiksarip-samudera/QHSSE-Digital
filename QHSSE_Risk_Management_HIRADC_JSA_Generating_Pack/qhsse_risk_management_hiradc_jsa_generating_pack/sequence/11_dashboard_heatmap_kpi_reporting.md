# RISK SEQUENCE 11 — Dashboard, Heatmap, KPI & Reporting

## Tujuan

Membuat risk dashboard, heatmap, top hazards, high risk activities, overdue review, open actions, critical controls, PDF/Excel export.
...
```text
Implementasikan Risk Sequence 11: Dashboard, Heatmap, KPI & Reporting.
