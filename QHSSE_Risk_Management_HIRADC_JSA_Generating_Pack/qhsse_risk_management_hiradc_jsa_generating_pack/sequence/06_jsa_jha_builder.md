# RISK SEQUENCE 06 — JSA / JHA Builder

## Tujuan

Membuat JSA berbasis job step: step pekerjaan, hazard per step, control per step, PPE/tools/permit requirement, residual risk, approval.
...
```text
Implementasikan Risk Sequence 06: JSA / JHA Builder.
